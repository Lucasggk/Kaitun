...
local ndt = nil
if terreno then ndt = terreno.Important.Data.Farm_Number.Value end
...
function tp(x) local char=game.Players.LocalPlayer.Character if char and char:FindFirstChild("HumanoidRootPart") then char.HumanoidRootPart.CFrame=CFrame.new(x) end end
